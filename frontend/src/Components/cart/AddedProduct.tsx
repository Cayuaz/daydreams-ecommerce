          ...
          <div className="flex gap-4 items-center relative">
            ...
            <div className="flex flex-col gap-2 flex-wrap">
              ...
              <div className="flex justify-center items-center gap-2">
                <Check className="hidden sm:block size-4" />{" "}
                <span className="text-[0.8rem] text-left">
              ...
              <button
                type="button"
                className={`text-center uppercase text-[0.8rem] bg-black w-full px-6 py-1 sm:py-2 rounded-sm hover:bg-[#0d0d0d]`}
                onClick={handleCart}
              >
                Ver carrinho
              </button>
            ...
            <X
              className="absolute -top-4 -right-1 size-4 cursor-pointer"
              onClick={handleClose}
            />
          </div>
        </motion.div>
